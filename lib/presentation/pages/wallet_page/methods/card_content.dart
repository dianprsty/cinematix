      ...
      children: [
        Column(
          ...
          children: [
            ...
            Text(
              (ref.read(userDataProvider).valueOrNull?.balance ?? 0)
                  .toIDRCurrencyFormat(),
              style: const TextStyle(
                color: Color(0xFFEAA96E),
                fontSize: 18,
        ...
        Column(
          ...
          children: [
            GestureDetector(
              onTap: () {
                ref.read(userDataProvider.notifier).topUp(10000);
              },
              child: Container(
                width: 30,
                height: 30,
                ...
                child: const Icon(Icons.add, color: Color(0xFFEAA96E)),
              ),
            ),
            const Text('Top Up',
